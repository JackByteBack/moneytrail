...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-md">
      <div className="bg-canvas rounded-xl p-8 shadow-[0_0_0_1px_rgba(14,15,12,0.12)]">
        <h1 className="font-display text-display-md text-ink mb-2">Welcome back</h1>
        ...
        <div className="mt-6">
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-canvas-soft" />
            </div>
          ...
          <button
            ...
            className="mt-4 w-full py-3 px-6 bg-canvas border border-ink text-ink font-button-md rounded-xl hover:scale-[1.05] active:scale-[0.95] transition-transform flex items-center justify-center gap-2"
          >
        ...
        <p className="mt-6 text-center text-body-sm text-muted">
          ...
          <Link href="/signup" className="text-ink font-body-sm-strong hover:underline">
            Sign up
          </Link>
        </p>
      </div>
